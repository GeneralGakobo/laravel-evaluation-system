    ...
    <div id="wrapper">
		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Dashboard <small>Register Answer Type</small>
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="#">Home</a></li>
					  <li><a href="#">Dashboard</a></li>
					  <li class="active">Reg_Answer</li>
					</ol> 
        ...
        <section class="wrapper main-wrapper row">        
          <div class="col-md-6">              
            ...
            <?php endif; ?>
        <form action="<?php echo e(route('dashboard.answer')); ?>" method="post" class="form-inline">
        <?php echo csrf_field(); ?>
            <div class="results">
            ...
            <label for="sem">Evaluation Answers</label><br>
            <input type="text" placeholder="Answer" name="answer_name" class="form-control">
            <span class="text-danger" style="color:red;"><?php $__errorArgs = ['answer_name'];
...
unset($__errorArgs, $__bag); ?></span>
            ...
            <div class="form-group">
            <select id="scores" name="score_id" class="form-control" required multiple>
					<option>---Select Scores----</option>
                    <?php
                    $conn = mysqli_connect("localhost","root","","auth")or die(mysqli_error());
                    $query = "SELECT * FROM scores";
                    $do =mysqli_query($conn, $query);
                    while($row = mysqli_fetch_array($do)){
                        echo "<option value='".$row['id']."'>".$row['score_name']."</option>";
                    }
         ...
         <div class="col-md-6" style="background-color:; margin-bottom:10px;">      
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                <?php $__currentLoopData = $answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($item->id); ?></td>
                                            <td><?php echo e($item->answer_name); ?></td>
                                            <td><?php echo e($item->score_id); ?></td>
                                       
                                            <td><a href="edit_session/<?php echo e($item->id); ?>" data-toggle="modal" data-target='#exampleModal'><button class="btn btn-info"><i class="fa fa-edt" style="color:blue; font-size:27px;"></i>Edit</button></a></td>
                                            <td><a href="delete_answer/<?php echo e($item->id); ?>"><button class="btn btn-danger" onclick="return confirm('Are you sure to delete?')"><i class="fa fa-remove" style="color:red; font-size:27px;"></i>Delete</button></a></td>
 
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#87ce22; height:120px;">
        <strong><h3 class="modal-title" id="exampleModalLabel" style="margin-left:50px;margin-top:30px; color:white">Edit Session</h3></strong>
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="cid" value="<?php echo e($item->id); ?>">
          ...
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Change Session Name:</label>
            <input type="text" name="sess_name" value="" class="form-control" id="sess_name">
          </div>
...
</html><?php /**PATH D:\xampp\htdocs\authentication\resources\views/dashboard/answer.blade.php ENDPATH**/ ?>