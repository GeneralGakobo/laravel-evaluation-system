		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Dashboard <small>View Lecturer</small>
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="#">Home</a></li>
					  <li><a href="#">Dashboard</a></li>
					  <li class="active">view_lecturer</li>
					</ol> 
        ...
        <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <?php $__currentLoopData = $lecturers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($program->id); ?></td>
                                            <td><?php echo e($program->lecturer_name); ?></td>
                                          
                                            <td><?php echo e($program->lecturer_email); ?></td>
                                            <td><?php echo e($program->department_id); ?></td>
                                            
                                            <td><?php echo e($program->lecturer_phone); ?></td>
...
</html><?php /**PATH D:\xampp\htdocs\authentication\resources\views/lecturer/view_lecturer.blade.php ENDPATH**/ ?>