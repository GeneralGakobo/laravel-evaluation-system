...
<body>
    <div id="wrapper">
		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Dashboard <small>Register School</small>
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="#">Home</a></li>
					  <li><a href="#">Dashboard</a></li>
					  <li class="active">Reg_Department</li>
					</ol> 
        ...
        <section class="wrapper main-wrapper row">        
          <div class="col-md-6">              
              <section class="box">
            <h3>Register School</h3><br>
            <br>
        <form action="<?php echo e(route('dashboard.department')); ?>" method="post" class="form-inline">
        <?php echo csrf_field(); ?>
            <div class="results">
            ...
            <label for="sem">Department Name</label><br>
            <input type="text" placeholder="Department Name" name="department_name" class="form-control">

            <br>
            <br>
            <div class="form-group">
            <select id="schools" name="school_id" class="form-control" required>
                ...
                <br>
                <br>
            <input class="btn btn-info" value="Register Department" name="save" type="submit">
        </div>
        </form>
        </section>
         </div>
...
</html><?php /**PATH D:\xampp\htdocs\authentication\resources\views/dashboard/departments.blade.php ENDPATH**/ ?>