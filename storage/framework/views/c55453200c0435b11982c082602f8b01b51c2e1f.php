		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Dashboard <small>Register Course</small>
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="#">Home</a></li>
					  <li><a href="#">Dashboard</a></li>
					  <li class="active">Register_Course</li>
					</ol> 
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="card-title">
                                        <div class="title">Register Coursesr</div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form action="<?php echo e(route('courses.course')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="results">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="text" name="course_code" class="form-control" id="exampleInputEmail1" placeholder="Enter Course Code">
                                        </div>
                                        ...
                                        <div class="form-group">
                                        <label for="exampleInputEmail1">Course Department</label>
                                        ...
                                        <div>
                                          ...
                                          <br>
                                          <br>
                                        <button type="submit" name="save" class="btn btn-info">Register Course</button>
                                    </form>
                                </div>
                            </div>
                        </div>
...
</html><?php /**PATH D:\xampp\htdocs\authentication\resources\views/courses/add_course.blade.php ENDPATH**/ ?>