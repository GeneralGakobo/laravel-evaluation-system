                ...
                <ul class="nav" id="main-menu" style="height:auto">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="<?php echo e(route('dashboard.schools')); ?>">Schools</a>
                            </li>
                           
                            <li>
                                <a href="<?php echo e(route('dashboard.departments')); ?>">Departments</a>
                            </li>
                         
                            <li>
                                <a href="<?php echo e(route('dashboard.programs')); ?>">Programs</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('answer.answer')); ?>">Answer Types</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('questionnaires.add_questionnaire')); ?>">Questionnaire</a>
                            </li>
                            <li>
                                <a href="#">Roles</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo e(route('student.add_student')); ?>">Add Student</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('student.view_student')); ?>">View Student</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo e(route('lecturer.add_lecturer')); ?>">Add Lecturer</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('lecturer.view_lecturer')); ?>">View Lecturer</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo e(route('competency.add_competency')); ?>">Add Competencies</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('competency.view_competency')); ?>">View Competencies</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo e(route('courses.add_course')); ?>">Add Courses</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('courses.view_course')); ?>">View Courses</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="<?php echo e(route('units.add_unit')); ?>"><i class="fa fa-sitemap"></i> Units<span class="fa arrow"></span></a>
...
</html><?php /**PATH D:\xampp\htdocs\authentication\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>