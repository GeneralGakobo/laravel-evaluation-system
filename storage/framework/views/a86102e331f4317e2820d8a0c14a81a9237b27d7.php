		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Dashboard <small>Register Lecturer</small>
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="#">Home</a></li>
					  <li><a href="#">Dashboard</a></li>
					  <li class="active">Register_Lecturer</li>
					</ol> 
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="card-title">
                                        <div class="title">Register Lecturer</div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form action="<?php echo e(route('lecturer.lecturer')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="results">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="text" name="lecturer_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Lecturer Name">
                                        </div>
                                      
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Lecturer Email</label>
                                            <input type="email" name="lecturer_email" class="form-control" id="exampleInputEmail1" placeholder="Enter Lecturer Email">
                                        </div>
                                        <div class="form-inline">
                                        <div class="form-group">
                                        <label for="exampleInputEmail1">Lecturer Department</label>
                                        <select id="schools" name="department_id" class="form-control" required>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Lecturer Phone</label>
                                            <input type="text" name="lecturer_phone" class="form-control" id="exampleInputEmail1" placeholder="Enter Lecturer Phone">
                                        </div>
                                        </div>
                                            <br>
                                            <br>
                                        <div>
                                          ...
                                          <br>
                                          <br>
                                        <button type="submit" name="save" class="btn btn-info">Register Lecturer</button>
                                    </form>
                                </div>
                            </div>
                        </div>
...
</html><?php /**PATH D:\xampp\htdocs\authentication\resources\views/lecturer/add_lecturer.blade.php ENDPATH**/ ?>