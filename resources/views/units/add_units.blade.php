    ...
    <div id="wrapper">
        ...
        @csrf
            ...
            <div class="form-inline">
                                        ...
                                        <span class="text-danger" style="color:red;">@error('course_id') {{ $message }} @enderror</span>
                                        ...
                                        <span class="text-danger" style="color:red;">@error('lecturer_id') {{ $message }} @enderror</span>
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="cid" value="{{ $item->id }}">
          ...
          <div class="form-group">
            ...
            <input type="text" name="sess_name" value="{{ $item->course_id}}" class="form-control" id="sess_name">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Update Lecturer:</label>
            <input type="text" name="sess_name" value="{{ $item->lecturer_id}}" class="form-control" id="sess_name">
          </div>
        </form>
      </div>
