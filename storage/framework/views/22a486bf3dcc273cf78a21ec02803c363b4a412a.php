    ...
    <div id="wrapper">
		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Dashboard <small>Register Session</small>
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="#">Home</a></li>
					  <li><a href="#">Dashboard</a></li>
					  <li class="active">Regsession</li>
					</ol> 
        ...
        <section class="wrapper main-wrapper row">        
          <div class="col-md-6">              
            ...
            <?php endif; ?>
        <form action="<?php echo e(route('dashboard.session')); ?>" method="post" class="form-inline">
        <?php echo csrf_field(); ?>
            <div class="results">
            ...
            <label for="sem">Academic Session</label><br>
            <input type="text" placeholder="Session" name="session_name" class="form-control">
            <span class="text-danger" style="color:red;"><?php $__errorArgs = ['session_name'];
                            ...
                            <div class="table-responsive">
                                ...
                                <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><a href="delete_session/<?php echo e($item->id); ?>"><button class="btn btn-danger" onclick="return confirm('Are you sure to delete?')"><i class="fa fa-remove" style="color:red; font-size:27px;"></i>Delete</button></a></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo e(route('dashboard.update')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <input type="hidden" name="cid" value="<?php echo e($item->id); ?>">
          ...
          <div class="form-group">
            ...
            <input type="text" name="sess_name" value="<?php echo e($item->session_name); ?>" class="form-control" id="sess_name">
          </div>
...
$(document).on("click", "#update_data", function() { 
    var url = "<?php echo e(URL('dashboard.edit_session'.$item->id)); ?>";
    var id= 
    $.ajax({
        url: url,
        type: "PATCH",
...
</html><?php /**PATH D:\xampp\htdocs\authentication\resources\views/dashboard/regsession.blade.php ENDPATH**/ ?>