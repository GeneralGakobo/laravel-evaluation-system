    ...
    <div id="wrapper">
        ...
        <section class="wrapper main-wrapper row">        
          <div class="col-md-6">              
            ...
            @endforeach
            @endif
        <form action="{{ route('dashboard.session') }}" method="post" class="form-inline">
        @csrf
            <div class="results">
            ...
            <span class="text-danger" style="color:red;">@error('session_name') {{ $message }} @enderror</span>
                            ...
                            <div class="table-responsive">
                                ...
                                @foreach($sessions as $item)
                                        <tr>
                                            ...
                                            <td><a href="delete_session/{{ $item->id }}"><button class="btn btn-danger" onclick="return confirm('Are you sure to delete?')"><i class="fa fa-remove" style="color:red; font-size:27px;"></i>Delete</button></a></td>
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="cid" value="{{ $item->id }}">
          ...
          <div class="form-group">
            ...
            <input type="text" name="sess_name" value="{{ $item->session_name }}" class="form-control" id="sess_name">
          </div>
...
$(document).on("click", "#update_data", function() { 
    var url = "{{URL('dashboard.edit_session'.$item->id)}}";
    var id= 
    $.ajax({
        url: url,
        type: "PATCH",
