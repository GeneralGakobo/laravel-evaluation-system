    ...
    <div id="wrapper">
        ...
        <section class="wrapper main-wrapper row">        
          <div class="col-md-6">              
            ...
            @endforeach
            @endif
        <form action="{{ route('dashboard.answer') }}" method="post" class="form-inline">
        @csrf
            <div class="results">
            ...
            <span class="text-danger" style="color:red;">@error('answer_name') {{ $message }} @enderror</span>
                            ...
                            <div class="table-responsive">
                                ...
                                @foreach($answers as $item)
                                        <tr>
                                            ...
                                            <td><a href="edit_session/{{ $item->id }}" data-toggle="modal" data-target='#exampleModal'><button class="btn btn-info"><i class="fa fa-edt" style="color:blue; font-size:27px;"></i>Edit</button></a></td>
                                            <td><a href="delete_answer/{{ $item->id }}"><button class="btn btn-danger" onclick="return confirm('Are you sure to delete?')"><i class="fa fa-remove" style="color:red; font-size:27px;"></i>Delete</button></a></td>
