    ...
    <div id="wrapper">
        ...
        <section class="wrapper main-wrapper row">        
          <div class="col-md-6">              
            ...
            <br>
        <form action="<?php echo e(route('dashboard.school')); ?>" method="post" class="form-inline">
        <?php echo csrf_field(); ?>
            <div class="results">
            ...
            <label for="sem">School Name</label><br>
            <input type="text" placeholder="School Name" name="school_name" class="form-control">

            <br>
            <br>

            <input class="btn btn-info" value="Register School" type="submit">
        </div>
        </form>
        </section>
         </div>
...
</html><?php /**PATH D:\xampp\htdocs\authentication\resources\views/dashboard/schools.blade.php ENDPATH**/ ?>