		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Dashboard <small>Add Competency</small>
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="#">Home</a></li>
					  <li><a href="#">Dashboard</a></li>
					  <li class="active">Register_Competency</li>
					</ol> 
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="card-title">
                                        <div class="title">Register Competency</div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form action="<?php echo e(route('competency.competency')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="results">
                                    ...
                                    <div class="form-group">
                                            <label for="exampleInputEmail1">Competency Name</label>
                                            <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Enter Competency Name">
                                        </div>
                                      
                                        <div class="form-inline">
                                        <div class="form-group">
                                        <label for="exampleInputEmail1">Answer Type</label>
                                        <select id="schools" name="_id" class="form-control" required>
...
</html><?php /**PATH D:\xampp\htdocs\authentication\resources\views/competencies/add_competency.blade.php ENDPATH**/ ?>