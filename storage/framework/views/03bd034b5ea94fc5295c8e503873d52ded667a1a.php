        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="<?php echo e(route('dashboard.index')); ?>"><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
...
<?php /**PATH D:\xampp\htdocs\authentication\resources\views/dashboard/uielements.blade.php ENDPATH**/ ?>