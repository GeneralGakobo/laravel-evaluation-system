		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Dashboard <small>Register Student</small>
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="#">Home</a></li>
					  <li><a href="#">Dashboard</a></li>
					  <li class="active">Register_student</li>
					</ol> 
                        ...
                        <div class="col-xs-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form action="<?php echo e(route('student.student')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="results">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="text" name="student_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Student Name">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Student Id</label>
                                            <input type="text" name="student_id" class="form-control" id="exampleInputEmail1" placeholder="Enter Student Id">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Student Email</label>
                                            <input type="email" name="student_email" class="form-control" id="exampleInputEmail1" placeholder="Enter Student Email">
                                        </div>
                                        <div class="form-inline">
                                        <div class="form-group">
                                        <label for="exampleInputEmail1">Student Program</label>
                                        <select id="schools" name="program_id" class="form-control" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="student_phone" class="form-control" id="exampleInputEmail1" placeholder="Enter Student Phone">
                                        </div>
                                        </div>
                                            <br>
                                            <br>
                                        <div>
                                        <label for="exampleInputEmail1">Student Gender</label><br>
                                          <div class="radio3 radio-check radio-inline">
                                            <input type="radio" id="radio4" name="student_gender" value="male" >
                                            <label for="radio4">
                                              Male
                                            </label>
                                          </div>
                                          <div class="radio3 radio-check radio-success radio-inline">
                                            <input type="radio" id="radio5" name="student_gender" value="female">
                                            <label for="radio5">
                                              Female
                                            </label>
                                          </div>
                                          <br>
                                          <br>
                                        <button type="submit" name="save" class="btn btn-info">Register Student</button>
                                    </form>
                                </div>
                            </div>
                        </div>
...
</html><?php /**PATH D:\xampp\htdocs\authentication\resources\views/student/add_student.blade.php ENDPATH**/ ?>